...
- [1 Allgemeines](#Start)
- [2 Namenskonventionen](#110330_14:29:29)
  - [2.1 Tabellen](#110928_08:56:27)
  - [2.2 Views](#110928_09:17:25)
- [3 Verwaltungstabellen](#110223_17:00:06)
  - [3.1 Tabelle kt_abfragen](#kt_abfragen)
  - [3.2 Tabelle kt_benutzer](#kt_benutzer)
  - [3.3 Tabelle kt_benutzerrechte](#kt_benutzerrechte)
  - [3.4 Tabelle kt_logbuch](#kt_logbuch)
  - [3.5 Tabelle kt_matviews](#kt_matviews)
  - [3.6 Tabelle kt_prozesse](#120820_16:18:27)
  - [3.7 Tabelle kt_rechte](#kt_rechte)
  - [3.8 Tabelle kt_rollen](#kt_rollen)
  - [3.9 Tabelle kt_rollenrechte](#kt_rollenrechte)
- [4 Fachdatentabellen](#110315_14:27:44)
  - [4.1 Tabelle dt_bemerkungen](#120326_11:39:06)
  - [4.2 Tabelle dt_fischarten](#dt_fischart)
  - [4.3 Tabelle dt_importdateien](#dt_importdateien)
  - [4.4 Tabelle dt_messstellen](#dt_messstellen)
  - [4.5 Tabelle dt_messstellen_history](#120820_16:46:00)
  - [4.6 Tabelle dt_messstellensynonyme](#120820_16:58:00)
  - [4.7 Tabelle dt_messvorgaenge](#dt_messvorgaenge)
  - [4.8 Tabelle dt_messvorgaenge_history](#120820_16:56:36)
  - [4.9 Tabelle dt_messwerte](#dt_messwerte)
  - [4.10 Tabelle dt_messwerte_history](#120820_17:02:56)
- [5 Schlüsseltabellen](#110315_15:00:04)
  - [5.1 Tabelle st_analysemethoden](#st_analysemethoden)
  - [5.2 Tabelle st_berechnungen](#st_berechnungen)
  - [5.3 Tabelle st_dateninhalte](#st_dateninhalte)
  - [5.4 Tabelle st_dienststellen](#120225_17:44:23)
  - [5.5 Tabelle st_einheiten](#st_einheiten)
  - [5.6 Tabelle st_einspielergebnisse](#st_einheiten)
  - [5.7 Tabelle st_gewaesser](#st_gewaesser)
  - [5.8 Tabelle st_grenzwertlisten](#st_grenzwertlisten)
  - [5.9 Tabelle st_koordinierungsraeume](#st_koordinierungsraeume)
  - [5.10 Tabelle st_laender](#st_laender)
  - [5.11 Tabelle st_listen](#st_listen)
  - [5.12 Tabelle st_medien](#st_medien)
  - [5.13 Tabelle st_messstellentypen](#st_messstellentypen)
  - [5.14 Tabelle st_messvorgangarten](#st_messstellentypen)
  - [5.15 Tabelle st_messwerttypen](#st_messstellentypen)
  - [5.16 Tabelle st_parameter](#st_parameter)
  - [5.17 Tabelle st_parametergruppen](#st_parametergruppen)
  - [5.18 Tabelle st_planungseinheiten](#120821_09:26:38)
  - [5.19 Tabelle st_status](#st_status)
  - [5.20 Tabelle st_wasserkoerper](#st_bearbeitungsgebiete)
- [6 Hilfstabellen](#110315_15:00:18)
  - [6.1 Tabelle zt_abflussreferenzen](#120225_17:46:10)
  - [6.2 Tabelle zt_datenpruefungen](#zt_datenpruefungen)
  - [6.3 Tabelle zt_einheitenzuordnungen](#zt_einheitenzuordnungen)
  - [6.4 Tabelle zt_einheitenumrechnungen](#zt_einheitenumrechnungen)
  - [6.5 Tabelle zt_grenzwerte](#zt_grenzwerte)
  - [6.6 Tabelle zt_gruppenzuordnungen](#zt_gruppenzuordnungen)
  - [6.7 Tabelle zt_klassen](#zt_klassen)
  - [6.8 Tabelle zt_umrechnungen](#zt_umrechnungen)
- [7 Tabellen zu statische Abfragen](#110928_08:47:32)


## <a id="Start"></a>1 Allgemeines
...
## <a id="110330_14:29:29"></a>2 Namenskonventionen
...
### <a id="110928_08:56:27"></a>2.1 Tabellen
...
### <a id="110928_09:17:25"></a>2.2 Views
...
## <a id="110223_17:00:06"></a>3 Verwaltungstabellen
...
### <a id="kt_abfragen"></a>3.1 Tabelle kt_abfragen
...
### <a id="kt_benutzer"></a>3.2 Tabelle kt_benutzer
...
### <a id="kt_benutzerrechte"></a>3.3 Tabelle kt_benutzerrechte
...
### <a id="kt_logbuch"></a>3.4 Tabelle kt_logbuch
...
### <a id="kt_matviews"></a>3.5 Tabelle kt_matviews
...
### <a id="120820_16:18:27"></a>3.6 Tabelle kt_prozesse
...
### <a id="kt_rechte"></a>3.7 Tabelle kt_rechte
...
### <a id="kt_rollen"></a>3.8 Tabelle kt_rollen
...
### <a id="kt_rollenrechte"></a>3.9 Tabelle kt_rollenrechte
...
## <a id="110315_14:27:44"></a>4 Fachdatentabellen
...
### <a id="120326_11:39:06"></a>4.1 Tabelle dt_bemerkungen
...
### <a id="dt_fischart"></a>4.2 Tabelle dt_fischarten
...
### <a id="dt_importdateien"></a>4.3 Tabelle dt_importdateien
...
### <a id="dt_messstellen"></a>4.4 Tabelle dt_messstellen
...
### <a id="120820_16:46:00"></a>4.5 Tabelle dt_messstellen
...
### <a id="120820_16:58:00"></a>4.6 Tabelle dt_messstellensynonyme
...
### <a id="dt_messvorgaenge"></a>4.7 Tabelle dt_messvorgaenge
...
### <a id="st_analysemethoden"></a>5.1 Tabelle st_analysemethoden
...
### <a id="st_berechnungen"></a>5.2 Tabelle st_berechnungen
...
### <a id="st_dateninhalte"></a>5.3 Tabelle st_dateninhalte
...
### <a id="st_einheiten"></a>5.6 Tabelle st_einspielergebnisse
...
### <a id="st_gewaesser"></a>5.7 Tabelle st_gewaesser
...
### <a id="st_grenzwertlisten"></a>5.8 Tabelle st_grenzwertlisten
...
### <a id="st_koordinierungsraeume"></a>5.9 Tabelle st_koordinierungsraeume
...
### <a id="st_laender"></a>5.10 Tabelle st_laender
...
### <a id="st_listen"></a>5.11 Tabelle st_listen
...
### <a id="st_medien"></a>5.12 Tabelle st_medien
...
### <a id="st_messstellentypen"></a>5.13 Tabelle st_messstellentypen
...
### <a id="st_messstellentypen"></a>5.14 Tabelle st_messvorgangarten
...
### <a id="st_messstellentypen"></a>5.15 Tabelle st_messwerttypen
...
### <a id="st_parameter"></a>5.16 Tabelle st_parameter
...
### <a id="st_parametergruppen"></a>5.17 Tabelle st_parametergruppen
...
### <a id="120821_09:26:38"></a>5.18 Tabelle st_planungseinheiten
...
### <a id="st_status"></a>5.19 Tabelle st_status
...
### <a id="st_bearbeitungsgebiete"></a>5.20 Tabelle st_wasserkoerper
...
## <a id="110315_15:00:18"></a>6 Hilfstabellen
...
### <a id="120225_17:46:10"></a>6.1 Tabelle zt_abflussreferenzen
...
### <a id="zt_datenpruefungen"></a>6.2 Tabelle zt_datenpruefungen
...
### <a id="zt_einheitenzuordnungen"></a>6.3 Tabelle zt_einheitenzuordnungen
...
### <a id="zt_einheitenumrechnungen"></a>6.4 Tabelle zt_einheitenumrechnungen
...
### <a id="zt_grenzwerte"></a>6.5 Tabelle zt_grenzwerte
...
### <a id="zt_gruppenzuordnungen"></a>6.6 Tabelle zt_gruppenzuordnungen
...
### <a id="zt_klassen"></a>6.7 Tabelle zt_klassen
...
### <a id="zt_umrechnungen"></a>6.8 Tabelle zt_umrechnungen
...
## <a id="110928_08:47:32"></a>7 Tabellen zu statische Abfragen
